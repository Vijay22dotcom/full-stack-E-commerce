...
//   return (
//     <>
//       <div className="cart   border font-sans  container  flex  bg-gray-200 p-[20px] max-[600]:flex-col ">
//         <div className="main border  w-[100%]     bg-white ">
...
//               return (
//                 <div
//                   className="cartiteam  border-b-2 flex w-[100%] "
//                   key={cart.id}
//                 >
...
//                     />
//                   </div>
//                   <div className="info ml-5 p-5 w-[50%] ">
